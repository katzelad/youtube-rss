    ...
    if (items) {
      ...
      if (len) {
        ...
        for (var i = 0; i < len; i++) {
          ...
          var description = htmlentities(items[i].videoDescription) + ' <br /> <iframe width="560" height="315" src="https://www.youtube.com/embed/'+items[i].videoId+'" frameborder="0" allowfullscreen="true"></iframe>';
